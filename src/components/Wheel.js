...
class Wheel extends React.Component {
            ...
            <div className="wheel-container" id="wheel-container">
                <div style={{ backgroundColor: wheelColor }} className="wheel" id="wheel">
                    ...
                    <div className="controll" id="forward">
                        ...
                        <FaFastForward className="controll" id='forward' style={{ color: theme }} />
                    </div>
                    <div className="controll" id="play-pause">
                        <div>
                            <FaPlay style={{ color: theme }} className="fas fa-play" />
                            <FaPause style={{ color: theme }} className="fas fa-pause" />
                        </div>
                    </div>
                    <div className="controll" id="reverse">
                        <FaFastBackward className="controll" id='reverse' style={{ color: theme }} />
                    </div>
                </div>
    ...
    componentDidMount() {
        const { changeMenuBackward, togglePlayPause, seekSongForward, seekSongBackword } = this.props;
